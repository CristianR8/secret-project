...
export default function Footer() {
  return (
    <div className="bg-[#2B3530] md:px-16">
      <div className="grid grid-rows-[repeat(3,auto)] border-b border-white/50 text-[#D1CCBF] md:grid-cols-[1fr_1.375fr] md:grid-rows-2 md:px-0 md:pt-20 md:pb-16 [&_.animated-underline]:bg-[#D1CCBF]">
        <div>
          <Image
            src={CvailLogo}
            alt="CVAIL Logo"
            ...
            priority
          />
          <ContactUs className="mt-8 w-fit flex-col gap-y-4 text-base max-md:mt-6" />
        </div>
